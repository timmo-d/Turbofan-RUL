...
h_filter = h2o.H2OFrame(p_train)
h_filter.set_names(list(p_train.columns))


h_test = h2o.H2OFrame(p_test)
h_test.set_names(list(p_test.columns))

training_columns = list(p_train.columns)
training_columns.remove('UnitNumber')
training_columns.remove('Time')
training_columns.remove('RUL')

columns = ['Setting1', 'Setting2', 'Sensor14', 'Sensor9', 'Sensor11', 'Sensor12', 'Sensor13', 'Sensor7', 'Sensor4', 'Sensor8', 'Sensor20', 'Sensor21', 'Sensor15', 'Sensor6', 'Sensor2', 'Sensor17', 'Sensor3']
